...
imp.load_module('electrum_pkb', *imp.find_module('lib'))

from electrum_pkb import SimpleConfig, Wallet, WalletStorage, format_satoshis
from electrum_pkb import util
from electrum_pkb.transaction import Transaction
from electrum_pkb.bitcoin import base_encode, base_decode
    ...
    content = """
      ...
      <LinearLayout 
        ...
        <TextView
          ...
          android:text="Electrum-PKB Authenticator"
...
class Authenticator:
    ...
    def __init__(self):
        global wallet
        self.qr_data = None
        storage = WalletStorage('/sdcard/electrum-pkb/authenticator')
