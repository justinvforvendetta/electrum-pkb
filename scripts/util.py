import time, electrum_pkb as electrum, Queue
from electrum_pkb import Interface, SimpleConfig
from electrum_pkb.network import filter_protocol, parse_servers
...
def get_peers():
    ...
    q = Queue.Queue()
    interface = electrum.Interface('electrum-pkb.net:50001:s', q)
    interface.start()
    i, r = q.get()
