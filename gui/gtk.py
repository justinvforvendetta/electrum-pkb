...
from electrum_pkb.util import print_error, InvalidPassword
from electrum_pkb.bitcoin import is_valid
from electrum_pkb import WalletStorage, Wallet

Gdk.threads_init()
APP_NAME = "Electrum-PKB"
import platform
MONOSPACE_FONT = 'Lucida Console' if platform.system() == 'Windows' else 'monospace'

from electrum_pkb.util import format_satoshis, parse_URI
from electrum_pkb.network import DEFAULT_SERVERS
from electrum_pkb.bitcoin import MIN_RELAY_TX_FEE
...
class ElectrumWindow:
    ...
    def __init__(self, wallet, config, network):
        ...
        title = 'Electrum-PKB ' + self.wallet.electrum_version + '  -  ' + self.config.path
        ...
        from electrum_pkb.util import StoreDict
    ...
    def do_send(self, w, data):
        ...
        if not is_valid(to_address):
            self.show_message( "invalid parkbyte address:\n"+to_address)
            return
