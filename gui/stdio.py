...
_ = lambda x:x
#from i18n import _
from electrum_pkb.wallet import WalletStorage, Wallet
from electrum_pkb.util import format_satoshis, set_verbosity, StoreDict
from electrum_pkb.bitcoin import is_valid
from electrum_pkb.network import filter_protocol
...
class ElectrumGui:
    ...
    def __init__(self, config, network):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'electrum-pkb create'"
            exit()
    ...
    def network_dialog(self):
        print("use 'electrum-pkb setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-pkb setconfig' to change your settings")
        return True
