...
from electrum_pkb.bitcoin import is_valid
...
import re
import time
from electrum_pkb.wallet import Wallet, WalletStorage
import webbrowser
import history_widget_lite
import receiving_widget
from electrum_pkb import util
import datetime

from electrum_pkb.version import ELECTRUM_VERSION as electrum_version
from electrum_pkb.util import format_satoshis, age
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.address_input.setPlaceholderText(_("Enter a ParkByte address or contact"))
        ...
        self.setWindowTitle("Electrum-PKB")
    ...
    def the_website(self):
        webbrowser.open("http://electrum-pkb.space")
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        label = QLabel(_("Copied your ParkByte address to the clipboard!"))
        ...
        self.setWindowTitle("Electrum - " + _("Receive ParkByte payment"))
