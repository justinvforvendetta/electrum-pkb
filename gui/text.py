...
_ = lambda x:x
#from i18n import _
from electrum_pkb.util import format_satoshis, set_verbosity
from electrum_pkb.util import StoreDict
from electrum_pkb.bitcoin import is_valid

from electrum_pkb import Wallet, WalletStorage
...
class ElectrumGui:
    ...
    def do_send(self):
        if not is_valid(self.str_recipient):
            self.show_message(_('Invalid parkbytecoin address'))
            return
        try:
